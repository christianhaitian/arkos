...
if [ ! -f "/home/ark/.config/.update11132020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11132020/emulationstation -O /usr/bin/emulationstation/emulationstation -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11132020/theme.xml -O /etc/emulationstation/themes/es-theme-nes-box/theme.xml -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update11142020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11142020/boot.ini -O /boot/boot.ini -a "$LOG_FILE"
	
	printf "\nAdd support for Rumble...\n" | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11142020/addrumblesupport-crontab -O /home/ark/addrumblesupport-crontab -a "$LOG_FILE"	
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11142020/enable_rumble -O /usr/local/bin/enable_rumble -a "$LOG_FILE"	
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11142020/pcsx_rearmed_libretro.so -O /home/ark/.config/retroarch32/cores/pcsx_rearmed_libretro.so -a "$LOG_FILE"	
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11142020/pcsx_rearmed_libretro.so.lck -O /home/ark/.config/retroarch32/cores/pcsx_rearmed_libretro.so.lck -a "$LOG_FILE"	
...
if [ ! -f "/home/ark/.config/.update11152020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11152020/flycast_rumble_libretro.so -O /home/ark/.config/retroarch/cores/flycast_rumble_libretro.so -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11152020/cap32_libretro.so -O /home/ark/.config/retroarch/cores/cap32_libretro.so -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11152020/gw_libretro.so -O /home/ark/.config/retroarch/cores/gw_libretro.so -a "$LOG_FILE"
	sudo cp -v /etc/emulationstation/es_systems.cfg /etc/emulationstation/es_systems.cfg.update11152020.bak | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11152020/es_systems.cfg -O /etc/emulationstation/es_systems.cfg -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11152020/es-theme-nes-box.zip -O /home/ark/es-theme-nes-box.zip -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update11162020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11162020/mgba_libretro.so -O /home/ark/.config/retroarch/cores/mgba_libretro.so -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11162020/mgba_libretro.so.lck -O /home/ark/.config/retroarch/cores/mgba_libretro.so.lck -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11162020/Change%20Password.sh -O /opt/system/"Change Password.sh" -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11162020/Network%20Info.sh -O /opt/system/"Network Info.sh" -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11162020/Update.sh -O /opt/system/Update.sh -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11162020/Wifi.sh -O /opt/system/Wifi.sh -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update11182020-1" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11182020/boot.ini -O /boot/boot.ini -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11182020/addledfix-crontab -O /home/ark/addledfix-crontab -a "$LOG_FILE"	
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11182020/fix_power_led -O /usr/local/bin/fix_power_led -a "$LOG_FILE"	
...
if [ ! -f "/home/ark/.config/.update1120020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11202020/mednafen_pce_fast_libretro.so -O /home/ark/.config/retroarch/cores/mednafen_pce_fast_libretro.so -a "$LOG_FILE"
	...
	sudo mv -v /usr/bin/emulationstation/emulationstation /usr/bin/emulationstation/emulationstation.update$UPDATE_DATE.bak | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11202020/emulationstation -O /usr/bin/emulationstation/emulationstation -a "$LOG_FILE"
	sudo chmod -v 777 /usr/bin/emulationstation/emulationstation | tee -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update11212020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11212020/BootFileUpdates.tar.gz -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11212020/KernelUpdate.tar.gz -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update11212020-1" ]; then
	...
	wget http://gitcdn.link/repo/christianhaitian/arkos/main/11212020-1/retroarch -O /opt/retroarch/bin/retroarch -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update11232020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11232020/BootFileUpdates.tar.gz -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11232020/KernelUpdate.tar.gz -a "$LOG_FILE"
	sudo tar --same-owner -zxvf BootFileUpdates.tar.gz -C / | tee -a "$LOG_FILE"
	sudo tar --same-owner -zxvf KernelUpdate.tar.gz -C / | tee -a "$LOG_FILE"
	sudo rm -v BootFileUpdates.tar.gz | tee -a "$LOG_FILE"
	sudo rm -v KernelUpdate.tar.gz | tee -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11232020/Normal%20Clock.sh -O /opt/system/Advanced/"Normal Clock".sh -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11232020/High%20Clock.sh -O /opt/system/Advanced/"High Clock".sh -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11232020/Check%20Current%20Max%20Speed.sh -O /opt/system/Advanced/"Check Current Max Speed".sh -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11232020/rk3326-rg351p-linux.dtb.13 -O /boot/rk3326-rg351p-linux.dtb.13 -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11232020/rk3326-rg351p-linux.dtb.15 -O /boot/rk3326-rg351p-linux.dtb.15 -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11232020/zh-CN/emulationstation2.po -O /usr/bin/emulationstation/resources/locale/zh-CN/emulationstation2.po -a "$LOG_FILE"
	...
	sudo mv -v /usr/bin/emulationstation/emulationstation /usr/bin/emulationstation/emulationstation.update$UPDATE_DATE.bak | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11232020/emulationstation -O /usr/bin/emulationstation/emulationstation -a "$LOG_FILE"
	sudo chmod -v 777 /usr/bin/emulationstation/emulationstation | tee -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update11242020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11242020/parallel_n64_libretro.so -O /home/ark/.config/retroarch32/cores/parallel_n64_libretro.so -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11242020/sdl_controllers.txt -O /roms/bios/pico-8/sdl_controllers.txt -a "$LOG_FILE"

	printf "\nAdd option to disable and enable wifi to options/Advanced section for those with internal wifi...\n" | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11242020/Enable%20Wifi.sh -O /opt/system/Advanced/"Enable Wifi".sh -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11242020/Disable%20Wifi.sh -O /opt/system/Advanced/"Disable Wifi".sh -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update11252020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11252020/64bit/mgba_libretro.so -O /home/ark/.config/retroarch/cores/mgba_libretro.so -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11252020/64bit/flycast_rumble_libretro.so -O /home/ark/.config/retroarch/cores/flycast_rumble_libretro.so -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11252020/32bit/parallel_n64_libretro.so -O /home/ark/.config/retroarch32/cores/parallel_n64_libretro.so -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11252020/32bit/pcsx_rearmed_libretro.so -O /home/ark/.config/retroarch32/cores/pcsx_rearmed_libretro.so -a "$LOG_FILE"
	sudo chmod -v 775 /home/ark/.config/retroarch/cores/mgba_libretro.so | tee -a "$LOG_FILE"
	sudo chown -v ark:ark /home/ark/.config/retroarch/cores/mgba_libretro.so | tee -a "$LOG_FILE"
	sudo chmod -v 775 /home/ark/.config/retroarch/cores/flycast_rumble_libretro.so | tee -a "$LOG_FILE"
	sudo chown -v ark:ark /home/ark/.config/retroarch/cores/flycast_rumble_libretro.so | tee -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update11272020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11272020/emulationstation -O /home/ark/emulationstation -a "$LOG_FILE"
	sudo mv -fv /home/ark/emulationstation /usr/bin/emulationstation/emulationstation | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11272020/timezones -O /usr/local/bin/timezones -a "$LOG_FILE"
	sudo chmod -v 777 /usr/bin/emulationstation/emulationstation | tee -a "$LOG_FILE"
	...
	wget http://gitcdn.link/repo/christianhaitian/arkos/main/11272020/retroarch32 -O /opt/retroarch/bin/retroarch32 -a "$LOG_FILE"
	...
	printf "\nInstall Atari ST...\n" | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11272020/hatari_libretro.so -O /home/ark/.config/retroarch/cores/hatari_libretro.so -a "$LOG_FILE"
	if [ ! -d "/home/ark/.hatari/" ]; then
		sudo mkdir -v /home/ark/.hatari | tee -a "$LOG_FILE"
		sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11272020/hatari.cfg -O /home/ark/.hatari/hatari.cfg -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11272020/es_systems.cfg -O /etc/emulationstation/es_systems.cfg -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11272020/vitaquake2_libretro.so -O /home/ark/.config/retroarch32/cores/vitaquake2_libretro.so -a "$LOG_FILE"
	...
	if [ ! -d "/roms/ports/quake2" ]; then
		...
		sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11272020/vitaQuakeII.rmp -O /home/ark/.config/retroarch32/config/remaps/vitaQuakeII/vitaQuakeII.rmp -a "$LOG_FILE"
		sudo chown -R -v ark:ark /home/ark/.config/retroarch32/config/remaps/vitaQuakeII/ | tee -a "$LOG_FILE"
		sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11272020/Quake%202.sh -O /roms/ports/"Quake 2".sh -a "$LOG_FILE"		
	fi
...
if [ ! -f "/home/ark/.config/.update11292020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11292020/emulationstation -O /home/ark/emulationstation -a "$LOG_FILE"
	sudo mv -fv /home/ark/emulationstation /usr/bin/emulationstation/emulationstation | tee -a "$LOG_FILE"
	sudo chmod -v 777 /usr/bin/emulationstation/emulationstation | tee -a "$LOG_FILE"

	printf "\nAdd Backup settings and Restore settings function to Options/Advance section...\n" | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11292020/Backup%20Settings.sh -O /opt/system/Advanced/"Backup Settings".sh -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11292020/Restore%20Settings.sh -O /opt/system/Advanced/"Restore Settings".sh -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11292020/amiga.sh -O /usr/local/bin/amiga.sh -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11292020/es_systems.cfg -O /etc/emulationstation/es_systems.cfg -a "$LOG_FILE"	
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11292020/scummvm.sh -O /usr/local/bin/scummvm.sh -a "$LOG_FILE"
	sudo mkdir -v /home/ark/.config/scummvm | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11292020/scummvm.ini -O /home/ark/.config/scummvm/scummvm.ini -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11292020/scummvm.tar.gz -O /home/ark/scummvm.tar.gz -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/11292020/gamecontrollerdb.txt -O /opt/scummvm/extra/gamecontrollerdb.txt -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update12012020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12012020/pcsx_rearmed_libretro.so -O /home/ark/.config/retroarch32/cores/pcsx_rearmed_libretro.so -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12012020/flycast_rumble_libretro.so -O /home/ark/.config/retroarch/cores/flycast_rumble_libretro.so -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12012020/parallel_n64_libretro.so -O /home/ark/.config/retroarch32/cores/parallel_n64_libretro.so -a "$LOG_FILE"
	sudo chmod -v 775 /home/ark/.config/retroarch/cores/flycast_rumble_libretro.so | tee -a "$LOG_FILE"
	sudo chown -v ark:ark /home/ark/.config/retroarch/cores/flycast_rumble_libretro.so | tee -a "$LOG_FILE"
	sudo chmod -v 775 /home/ark/.config/retroarch32/cores/parallel_n64_libretro.so | tee -a "$LOG_FILE"
	sudo chown -v ark:ark /home/ark/.config/retroarch32/cores/parallel_n64_libretro.so | tee -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12012020/tic80_libretro.so -O /home/ark/.config/retroarch/cores/tic80_libretro.so -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12012020/es-theme-nes-box.zip -O /home/ark/es-theme-nes-box.zip -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12012020/es-theme-switch.zip -O /home/ark/es-theme-switch.zip -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12012020/es-theme-epicnoir.zip -O /home/ark/es-theme-epicnoir.zip -a "$LOG_FILE"
	sudo runuser -l ark -c 'unzip -o /home/ark/es-theme-nes-box.zip -d /etc/emulationstation/themes/es-theme-nes-box/' | tee -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12012020/es_systems.cfg -O /home/ark/es_systems.cfg -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update12032020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12032020/mgba_libretro.so -O /home/ark/.config/retroarch/cores/mgba_libretro.so -a "$LOG_FILE"
	sudo chmod -v 775 /home/ark/.config/retroarch/cores/mgba_libretro.so | tee -a "$LOG_FILE"
	sudo chown -v ark:ark /home/ark/.config/retroarch/cores/mgba_libretro.so | tee -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12032020/pt/emulationstation2.po -O /usr/bin/emulationstation/resources/locale/pt/emulationstation2.po -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update12072020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12072020/es_systems.cfg -O /home/ark/es_systems.cfg -a "$LOG_FILE"
	if [ -f "/home/ark/es_systems.cfg" ]; then
		sudo mv -v /home/ark/es_systems.cfg /etc/emulationstation/es_systems.cfg | tee -a "$LOG_FILE"
	fi
	sudo chmod -v 775 /etc/emulationstation/es_systems.cfg | tee -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12072020/PPSSPPSDL -O /opt/ppsspp/PPSSPPSDL -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12072020/gamecontrollerdb.txt -O /opt/ppsspp/assets/gamecontrollerdb.txt -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12072020/filebrowser -O /usr/local/bin/filebrowser -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12072020/filebrowser.db -O /home/ark/.config/filebrowser.db -a "$LOG_FILE"
	sudo mkdir -v /home/ark/.config/img | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12072020/logo.svg -O /home/ark/.config/img/logo.svg -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12072020/Disable%20Remote%20Services.sh -O /opt/system/"Disable Remote Services".sh -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12072020/Enable%20Remote%20Services.sh -O /opt/system/"Enable Remote Services".sh -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12072020/filebrowser -O /usr/local/bin/filebrowser -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update12092020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12092020/es_systems.cfg -O /home/ark/es_systems.cfg -a "$LOG_FILE"
	if [ -f "/home/ark/es_systems.cfg" ]; then
		sudo mv -v /home/ark/es_systems.cfg /etc/emulationstation/es_systems.cfg | tee -a "$LOG_FILE"
	fi
	sudo chmod -v 775 /etc/emulationstation/es_systems.cfg | tee -a "$LOG_FILE"
	sudo chown -v ark:ark /etc/emulationstation/es_systems.cfg | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12092020/mgba_rumble_libretro.so -O /home/ark/.config/retroarch/cores/mgba_rumble_libretro.so -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12092020/mgba_libretro.so -O /home/ark/.config/retroarch/cores/mgba_libretro.so -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12092020/vbam_libretro.so -O /home/ark/.config/retroarch/cores/vbam_libretro.so -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12092020/vba_next_libretro.so -O /home/ark/.config/retroarch/cores/vba_next_libretro.so -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update12122020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12122020/Devilutionx.sh -O /roms/ports/Devilutionx.sh -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12122020/devilutionx -O /home/ark/.config/devilution/devilutionx -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12122020/gamecontrollerdb.txt -O /roms/ports/devilution/gamecontrollerdb.txt -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12122020/CharisSILB.ttf -O /usr/share/fonts/truetype/CharisSILB.ttf -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12122020/libSDL2_mixer.a -O /usr/lib/arm-linux-gnueabihf/libSDL2_mixer.a -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12122020/libSDL2_mixer-2.0.so.0.2.2 -O /usr/lib/arm-linux-gnueabihf/libSDL2_mixer-2.0.so.0.2.2 -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12122020/libmodplug.so.1.0.0 -O /usr/lib/arm-linux-gnueabihf/libmodplug.so.1.0.0 -a "$LOG_FILE"
	sudo ln -s -v /usr/lib/arm-linux-gnueabihf/libmodplug.so.1.0.0 /usr/lib/arm-linux-gnueabihf/libmodplug.so.1 | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12122020/libopusfile.so.0.4.2 -O /usr/lib/arm-linux-gnueabihf/libopusfile.so.0.4.2 -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12122020/libopusfile.a -O /usr/lib/arm-linux-gnueabihf/libopusfile.a -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12122020/libopusurl.a -O /usr/lib/arm-linux-gnueabihf/libopusurl.a -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12122020/libopusurl.so.0.4.2 -O /usr/lib/arm-linux-gnueabihf/libopusurl.so.0.4.2 -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12122020/Backup%20Settings.sh -O /opt/system/Advanced/"Backup Settings".sh -a "$LOG_FILE"
	sudo chmod -v 777 /opt/system/Advanced/"Backup Settings".sh | tee -a "$LOG_FILE"
	sudo chown -v ark:ark /opt/system/Advanced/"Backup Settings".sh | tee -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update12152020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/libmali-rk-bifrost-g31-rxp0-wayland-gbm_1.7-2+deb10_arm64.deb -O /home/ark/libmali-rk-bifrost-g31-rxp0-wayland-gbm_1.7-2+deb10_arm64.deb -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/libsdl2-2.0-0_2.0.10+dfsg1-1ubuntu1_arm64.deb -O /home/ark/libsdl2-2.0-0_2.0.10+dfsg1-1ubuntu1_arm64.deb -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/libSDL2_image.a -O /usr/lib/aarch64-linux-gnu/libSDL2_image.a -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/libSDL2_image-2.0.so.0.2.2 -O /usr/lib/aarch64-linux-gnu/libSDL2_image-2.0.so.0.2.2 -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/libjpeg.a -O /usr/lib/aarch64-linux-gnu/libjpeg.a -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/libjpeg.so.62.2.0 -O /usr/lib/aarch64-linux-gnu/libjpeg.so.62.2.0 -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/libjpegxr.so.1.1 -O /usr/lib/aarch64-linux-gnu/libjpegxr.so.1.1 -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/libSDL2_ttf.a -O /usr/lib/aarch64-linux-gnu/libSDL2_ttf.a -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/libSDL2_ttf-2.0.so.0.14.1 -O /usr/lib/aarch64-linux-gnu/libSDL2_ttf-2.0.so.0.14.1 -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/image-viewer -O /usr/local/bin/image-viewer -a "$LOG_FILE"
	sudo chmod -v 777 /usr/local/bin/image-viewer | tee -a "$LOG_FILE"
	sudo mkdir -v /roms/launchimages | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/loading.jpg -O /roms/launchimages/loading.jpg -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/CGeniusExe -O /home/ark/.config/CGenius/CGeniusExe -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/cgenius.cfg -O /home/ark/.CommanderGenius/cgenius.cfg -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/keen-shr.zip -O /home/ark/keen-shr.zip -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/Commander%20Genius.sh -O /roms/ports/"Commander Genius".sh -a "$LOG_FILE"
	...
	#sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/OpenBor -O /home/ark/.config/OpenBor/OpenBor -a "$LOG_FILE"
	#sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/OpenBor.elf -O /home/ark/.config/OpenBor/OpenBor.elf -a "$LOG_FILE"
	#sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/master.cfg -O /home/ark/.config/OpenBor/master.cfg -a "$LOG_FILE"
	#sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/libvpx.a -O /usr/lib/aarch64-linux-gnu/libvpx.a -a "$LOG_FILE"
	#sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/libvpx.so.5.0.0 -O /usr/lib/aarch64-linux-gnu/libvpx.so.5.0.0 -a "$LOG_FILE"
	#sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/OpenBor.sh -O /roms/ports/OpenBor.sh -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/opentyrian-arkos.tar.gz -O /home/ark/opentyrian-arkos.tar.gz -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/otyriandata.zip -O /home/ark/otyriandata.zip -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/OpenTyrian.sh -O /roms/ports/OpenTyrian.sh -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/perfmax -O /usr/local/bin/perfmax -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/perfnorm -O /usr/local/bin/perfnorm -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/sources.list -O /etc/apt/sources.list -a "$LOG_FILE"

	printf "\nFix L2 button for devilutionX...\n" | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/gamecontrollerdb.txt -O /roms/ports/devilution/gamecontrollerdb.txt -a "$LOG_FILE"

	printf "\nReally Update Backup script this time to not include cheats and overlays to speed up process...\n" | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/Backup%20Settings.sh -O /opt/system/Advanced/"Backup Settings".sh -a "$LOG_FILE"
	sudo chmod -v 777 /opt/system/Advanced/"Backup Settings".sh | tee -a "$LOG_FILE"
	sudo chown -v ark:ark /opt/system/Advanced/"Backup Settings".sh | tee -a "$LOG_FILE"
	...
	#sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/pt/emulationstation2.po.de -O /usr/bin/emulationstation/resources/locale/de/emulationstation2.po -a "$LOG_FILE"
	#sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/pt/emulationstation2.po.es -O /usr/bin/emulationstation/resources/locale/es/emulationstation2.po -a "$LOG_FILE"
	#sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12152020/pt/emulationstation2.po.fr -O /usr/bin/emulationstation/resources/locale/pr/emulationstation2.po -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update12162020" ]; then
	...
	sudo mkdir -v /usr/bin/emulationstation/resources/locale/de/ | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12162020/emulationstation2.po.de -O /usr/bin/emulationstation/resources/locale/de/emulationstation2.po -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12162020/emulationstation2.po.es -O /usr/bin/emulationstation/resources/locale/es/emulationstation2.po -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12162020/emulationstation2.po.fr -O /usr/bin/emulationstation/resources/locale/fr/emulationstation2.po -a "$LOG_FILE"

	printf "\nAdd update for a few themes to support Solarus and lzdoom system entry...\n" | tee -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12162020/es-theme-nes-box.zip -O /home/ark/es-theme-nes-box.zip -a "$LOG_FILE"
	sudo runuser -l ark -c 'unzip -o /home/ark/es-theme-nes-box.zip -d /etc/emulationstation/themes/es-theme-nes-box/' | tee -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12162020/es_systems.cfg -O /home/ark/es_systems.cfg -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12162020/lzdoom.tar.gz -O /home/ark/lzdoom.tar.gz -a "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12162020/doom.sh -O /usr/local/bin/doom.sh -a "$LOG_FILE"
	if [ -f "/home/ark/es_systems.cfg" ]; then
		sudo mv -v /home/ark/es_systems.cfg /etc/emulationstation/es_systems.cfg | tee -a "$LOG_FILE"
	fi
	sudo chmod -v 775 /etc/emulationstation/es_systems.cfg | tee -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12162020/solarus.tar.gz -O /home/ark/solarus.tar.gz "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12162020/solarus.sh -O /usr/local/bin/solarus.sh "$LOG_FILE"
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12162020/solarushotkeydemon.py -O /usr/local/bin/solarushotkeydemon.py "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update12182020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12182020/arkosupdate12182020.zip -O /home/ark/arkosupdate12182020.zip -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update12192020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12192020/arkosupdate12192020.zip -O /home/ark/arkosupdate12192020.zip -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update12192020-1" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12192020-1/arkosupdate12192020-1.zip -O /home/ark/arkosupdate12192020-1.zip -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update12212020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12212020/arkosupdate12212020.zip -O /home/ark/arkosupdate12212020.zip -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update12212020-1" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12212020-1/arkosupdate12212020-1.zip -O /home/ark/arkosupdate12212020-1.zip -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update12222020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12222020/arkosupdate12222020.zip -O /home/ark/arkosupdate12222020.zip -a "$LOG_FILE"
	if [ -f "/home/ark/arkosupdate12222020.zip" ]; then
		...
		sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12222020/XASH3D_LICENSE -O /roms/ports/Half-Life/XASH3D_LICENSE -a "$LOG_FILE"
	else 
		printf "\nThe update couldn't complete because the package did not download correctly.\nPlease retry the update again." | tee -a "$LOG_FILE"
		echo $c_brightness > /sys/devices/platform/backlight/backlight/backlight/brightness
		exit 1
...
if [ ! -f "/home/ark/.config/.update12262020-1" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12262020-1/DinguxCommander -O /opt/dingux/DinguxCommander -a "$LOG_FILE"
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12262020-1/oshgamepad.cfg -O /opt/dingux/oshgamepad.cfg -a "$LOG_FILE"
	sudo dpkg -i /opt/dingux/libsdl2-gfx-1.0-0_1.0.4+dfsg-3_armhf.deb
	sudo rm -v /opt/dingux/libsdl2-gfx-1.0-0_1.0.4+dfsg-3_armhf.deb | tee -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update12272020" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/12272020/arkosupdate12272020.zip -O /home/ark/arkosupdate12272020.zip -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update01022021" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/01022021/rg351p/arkosupdate01022021.zip -O /home/ark/arkosupdate01022021.zip -a "$LOG_FILE" || rm -f /home/ark/arkosupdate01022021.zip | tee -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update01042021" ]; then
	...
	printf "\nUpdate low battery warning python script to flash on 19 percent or lower\n"
		sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/01042021/arkosupdate01042021.zip -O /home/ark/arkosupdate01042021.zip -a "$LOG_FILE" || rm -f /home/ark/arkosupdate01042021.zip | tee -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update01052021" ]; then
	...
	printf "\nIncrease audio period and buffer sizes temporarily for Drastic\nFix excessive cpu usage from batt_life_warning script\nAdded updated retroarch with netplay fix\n"
		sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/01052021/arkosupdate01052021.zip -O /home/ark/arkosupdate01052021.zip -a "$LOG_FILE" || rm -f /home/ark/arkosupdate01052021.zip | tee -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update01102021" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/01102021/arkosupdate01102021.zip -O /home/ark/arkosupdate01102021.zip -a "$LOG_FILE" || rm -f /home/ark/arkosupdate01102021.zip | tee -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update01112021" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/01112021/arkosupdate01112021.zip -O /home/ark/arkosupdate01112021.zip -a "$LOG_FILE" || rm -f /home/ark/arkosupdate01112021.zip | tee -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update01152021" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/01152021/arkosupdate01152021.zip -O /home/ark/arkosupdate01152021.zip -a "$LOG_FILE" || rm -f /home/ark/arkosupdate01152021.zip | tee -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update01282021" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/01282021/arkosupdate01282021.zip -O /home/ark/arkosupdate01282021.zip -a "$LOG_FILE" || rm -f /home/ark/arkosupdate01282021.zip | tee -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update01292021" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/01292021/arkosupdate01292021.zip -O /home/ark/arkosupdate01292021.zip -a "$LOG_FILE" || rm -f /home/ark/arkosupdate01292021.zip | tee -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update02032021" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/02032021/arkosupdate02032021.zip -O /home/ark/arkosupdate02032021.zip -a "$LOG_FILE" || rm -f /home/ark/arkosupdate02032021.zip | tee -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update02272021" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/02272021/arkosupdate02272021.zip -O /home/ark/arkosupdate02272021.zip -a "$LOG_FILE" || rm -f /home/ark/arkosupdate02272021.zip | tee -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.kernelupdate02032021" ]; then
	...
	sudo wget http://gitcdn.link/repo/christianhaitian/arkos/main/03082021/newkernelnmodndtb02032021.zip -O /home/ark/newkernelnmodndtb02032021.zip -a "$LOG_FILE" || rm -f /home/ark/newkernelnmodndtb02032021.zip | tee -a "$LOG_FILE"
...
if [ ! -f "/home/ark/.config/.update03182021" ]; then
	...
	sudo wget http://gitcdn.link/cdn/christianhaitian/arkos/main/03182021/arkosupdate03182021.zip -O /home/ark/arkosupdate03182021.zip -a "$LOG_FILE" || rm -f /home/ark/arkosupdate03182021.zip | tee -a "$LOG_FILE"
...
if [ ! -f "$UPDATE_DONE" ]; then
	...
	sudo wget http://gitcdn.link/cdn/christianhaitian/arkos/main/03182021-1/arkosupdate03182021-1.zip -O /home/ark/arkosupdate03182021-1.zip -a "$LOG_FILE" || rm -f /home/ark/arkosupdate03182021-1.zip | tee -a "$LOG_FILE"
